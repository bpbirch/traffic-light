...
from traffic_light.service.traffic_light_cli import run_traffic_light  # Adjust the import to your module's name
...
class ClickCLITestCast(TestCase):
    ...
    def test_color_inputs_greater_than_zero(self) -> None:
        ...
        result = self.runner.invoke(run_traffic_light, input='0\n0\n0\nn\n1\n1\n1\nn\n')
        self.assertIn("Total light color times must be greater than zero", result.output)
